			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Konfirmasi Pemesanan</h2>
...
echo htmlentities('Confirmed');
 	...
 	echo htmlentities('Cancelled');
										...
										<td>
  <a href="dataofrent.php?endrent=<?php echo htmlentities($result['id']);?>" onclick="return confirm('Are you sure you want to mark this booking as End of Rent?');">End of Rent</a>
</td>
